        ...
        <div class="container-fluid justify-content-center">
            ...
            <div class="collapse navbar-collapse text-center flex-grow-0" id="navbarResponsive">
                ...
                <ul class="blink1 navbar-nav text-uppercase ml-auto" id="ulNavbar">
                    ...
                    <li class="nav-item">
                        <div>
                            <a class="nav-link js-scroll-trigger" id="regist-nav" href="log"
                ...
                <div class="col-md-12">
                    <div class="blink block wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <form  action="">
                            ...
                            <div>
                                <a href="reg" class="mx-auto col-2 regis text-center mt-3"
                                    style="display:block;color:#333" id=" simpan">
                                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                                    Buat Akun Baru</a>
                                <a href="res" class="mx-auto col-1 regis text-center"
                                    style="display:block;color:#333" id=" simpan">
