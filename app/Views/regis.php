        ...
        <div class="container-fluid justify-content-center">
            ...
            <div class="collapse navbar-collapse text-center flex-grow-0" id="navbarResponsive">
                ...
                <ul class="blink1 navbar-nav text-uppercase ml-auto" id="ulNavbar">
                    ...
                    <li class="nav-item">
                        <div>
                            <a class="nav-link js-scroll-trigger" id="regist-nav" href="reg"
                    ...
                    <div class="blink">
                        ...
                        <form action="">
                            <div class="col-4 mx-auto coba">
                                <div class="mb-3 entryarea">
                                    <input type="text">
                                    <div class="labelline">Nama</div>
                                </div>
                                <div class="mb-3 entryarea">
                                    <input type="text">
                                    <div class="labelline">Jurusan</div>
                                </div>
                                <div class="mb-3 entryarea">
                                    <input type="tel">
                                    <div class="labelline">Nomor Telepon</div>
                                </div>
                                <div class="mb-3 entryarea">
                                    <input type="email">
                            ...
                            <div class="text-center">
                                ...
                                <div>
                                <a href="log" class="mx-auto col-2 regis text-center mt-1 mb-5"
                                    style="display:block;color:#333" id=" simpan">
